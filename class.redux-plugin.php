        ...
        class ReduxFrameworkPlugin {
            ...
            public function plugin_metalinks( $links, $file ) {
                if ( strpos( $file, 'redux-framework.php' ) !== false && is_plugin_active( $file ) ) {
                    ...
                    $new_links = array(
                        '<a href="https://github.com/wpsearch/redux-framework" target="_blank">' . __( 'Repo', 'redux-framework' ) . '</a>',
                        '<a href="http://generate.reduxframework.com/" target="_blank">' . __( 'Generator', 'redux-framework' ) . '</a>',
                        '<a href="https://github.com/wpsearch/redux-framework/issues/" target="_blank">' . __( 'Issues', 'redux-framework' ) . '</a>',
